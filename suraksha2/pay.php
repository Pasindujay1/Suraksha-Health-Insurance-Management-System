...
<div class="sidebar2">
    ...
    <h1 class="adminTopic">Receiving Transaction List...</h1>
...
<?php
    ...
    $sqlget="SELECT * FROM transaction";
...
<br>
                       ...
                       <a href="AddCardDetails.php">     <button class="btnPolicy">Add New Transaction</button></a>
