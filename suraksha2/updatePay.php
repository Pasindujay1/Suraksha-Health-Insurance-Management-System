...
<div class="sidebar2">
    ...
    <?php 
       ...
       $query="UPDATE `transaction` SET Customer_Name='$cus_name',Nic='$nic',Date_='$date',Paid_Amount='$paid_amount' where id=$id";
       ...
       $query_run=mysqli_query($conn,$query);
         ...
         if($query_run){
           ...
           echo '<script type="text/javascript">alert("details updated sucessfully!!!")</script>';
...
<!--
        ...
        <div class="input_wrap">
          ...
          <input type="submit" value="Update Transaction details" class="submit_btn" name="updateTransaction">
